...
interface LocalStream extends Stream {
  /** 
...
interface RemoteStream extends Stream {
  /**
...
interface TurnServerConfig extends Omit<RTCIceServer, 'urls'> {
  /** TURN server url */
  url: string;
}
...
*/
type Role = 'anchor' | 'audience';
type RemoteStreamType = 'main' | 'auxiliary';
...
type VideoProfileString = '120p' | '180p' | '240p' | '360p' | '480p' | '720p' | '1080p' | '1440p' | '4K';

type ScreenProfileString = '480p' | '480p_2' | '720p' | '720p_2' | '1080p' | '1080p_2';
...
interface PublishCDNStreamOptions {
